...
class Translations_managerTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.translations_manager = Translations_manager("tests/languages.yml", "tests/translations_tmp/")
    ...
    def test_create_yaml_file(self):
        ...
        self.assertEqual(dir_files, ["./tests/translations_tmp/english.yml", "./tests/translations_tmp/french.yml", "./tests/translations_tmp/german.yml"])
    ...
    def test_fill_yaml_file(self):
        ...
        ci_list = CI_list()
        ci_list.load_xml("tests/ci_two_news.xml")
